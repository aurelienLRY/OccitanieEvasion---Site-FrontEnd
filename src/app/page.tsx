  ...
  return (
    <>
      ...
      <p>
            ...
            air, je vous propose une évasion adaptée à vos envies. Que ce soit
            en Canyoning, Escalade, Spéléo ou Via Corda, c’est avec passion que
            je vous ferai découvrir ces activités.
          </p>
          <p>
            Entre l’Aude, le Tarn, les Pyrénées Orientales et l’Hérault, le
            choix peut être difficile à faire au vu de la richesse sauvage de ce
            vaste territoire. Vous trouverez ici une sélection de sites naturels
            et lieux de pratique que j’affectionne particulièrement.
          </p>
      </section>
